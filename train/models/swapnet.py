...
class _ConvLayer(nn.Sequential):
    def __init__(self, input_features, output_features):
        ...
        self.add_module('batchnorm', nn.BatchNorm2d(output_features))
...
class _UpScale(nn.Sequential):
    def __init__(self, input_features, output_features):
        ...
        self.add_module('conv2_', Conv2d(input_features, output_features * 4,
                                         kernel_size=3))
        self.add_module('batchnorm', nn.BatchNorm2d(output_features * 4))
        self.add_module('leakyrelu', nn.LeakyReLU(0.1, inplace=True))
...
class SwapNet128(nn.Module):
    def __init__(self):
        super(SwapNet128, self).__init__()
